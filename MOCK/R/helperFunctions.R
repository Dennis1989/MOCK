...
#' @title Filter and normalization of a paretro front
#' @param Minimumdev minimum value for deviation
#' @param Maximumdev maximum value for deviation
#' @param Minimumconn Minimum value for connectivity
#' @param Maximumconn Maximum value for connectivity
#' @export
